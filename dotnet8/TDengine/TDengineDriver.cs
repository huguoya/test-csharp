...
public class TDengine
{
    ...
    static public List<TDengineMeta> FetchFields(nint res)
    {
        ...
        nint fieldsPtr = taos_fetch_fields(res);
    ...
    static extern public nint FetchRows(nint res);

    [DllImport("taos", EntryPoint = "taos_free_result", CallingConvention = CallingConvention.Cdecl)]
    static extern public nint FreeResult(nint res);

    [DllImport("taos", EntryPoint = "taos_close", CallingConvention = CallingConvention.Cdecl)]
    static extern public int Close(nint taos);
    ...
    static extern public int ResultPrecision(nint taos);
}
